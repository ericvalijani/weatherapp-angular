I used CoreUI FREE admin dashboard template

just programmed the code inside src/app/views and wrote comments for the codes

it has three components: 
main is dashboard
two: weather card for each city
three: forecast tab which I used free CSS library

codes have child to parent pass methods too,
 like passing title from card component(child) to dashboard(parent) in order to get the forecast of the city or removing the city
